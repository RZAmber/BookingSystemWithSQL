...
public class checkpage extends JFrame{
	...
	resultpage rp = new resultpage(roomType, amount, location,
			checkIn, checkOut,  comments, days, amount1, amount2, amount3, amount4, roomType1, roomType2, roomType3, roomType4, email, Fname, Lname,phone);
	...
	public checkpage(String location, String checkIn, String checkOut ,String roomType, int amount, int days, int amount1, int amount2, int amount3, int amount4, 
			String roomType1, String roomType2, String roomType3, String roomType4, String email, String firstname, String lastname, int phone1) {
		Fname=firstname;
		Lname=lastname;
		this.phone1=phone1;
