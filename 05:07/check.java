...
public class check extends resultpage{
	...
	public check(String Fname, String Lname, String roomType, int amount, String location, String checkIn,
		...
		super( roomType, amount, location, checkIn, checkOut, comments, days, amount1, amount2, amount3, amount4, roomType1, roomType2, roomType3, roomType4,email,Fname, Lname,phone);
		this.Fname = Fname;
		this.Lname = Lname;
