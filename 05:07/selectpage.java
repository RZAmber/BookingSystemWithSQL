...
public class selectpage extends JFrame{
	 ...
	 * Create the frame.
	 */
	public selectpage(String location, String checkIn, String checkOut, int days,String email, String firstname, String lastname, int phone) {
	...
	/*	Integer[] data = new Integer[4];
		...
		*/
		...
		lblDeluxeSingleRoom.setBounds(6, 299, 155, 33);
		...
		lblSuitRoom.setBounds(54, 445, 61, 16);
		...
		txtrJieshao.setBounds(198, 66, 238, 120);
		...
		txtrRoomInfo.setBounds(198, 187, 238, 120);
		...
		txtrRoomInfo_1.setBounds(198, 309, 238, 120);
		...
		txtrRoomInfo_2.setBounds(198, 430, 238, 120);
		...
		btnConfirm.addActionListener(new ActionListener(){
 			public void actionPerformed(ActionEvent e){
 				if (a[0] != 0){
 					amount1 = a[0]; roomType1 = r[0];
 				} else {
 					roomType1 = "";
 				}
 				if (a[1] != 0){
 					amount2 = a[1]; roomType2 = r[1];
 				} else {
 					roomType2 = "";
 				}
 				if (a[2] != 0){
 					amount3 = a[2]; roomType3 = r[2];
 				} else {
 					roomType3 = "";
 				}
 				if (a[3] != 0){
 					amount4 = a[3]; roomType4 = r[3];
 				} else {
 					roomType4 = "";
 				}
 				/*
 				...
 				*/
 				...
 				roomType = roomType1 + " " + roomType2 + " " + roomType3 + " " + roomType4;
 				System.out.println(roomType);
 				checkpage cp = new checkpage(location,  checkIn,  checkOut, roomType, amount, days, amount1, amount2, amount3, amount4,
 						roomType1, roomType2, roomType3, roomType4,email, firstname, lastname, phone);
 				cp.setVisible(true);
 				setVisible(false);
		...
		btnCanel.addActionListener(new ActionListener(){
 			public void actionPerformed(ActionEvent e){
 			HomePage hp = new HomePage(email, firstname, lastname,phone);
