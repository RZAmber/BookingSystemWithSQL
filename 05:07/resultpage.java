...
public class resultpage extends JFrame {
	...
	*/
	 ...
	 * Create the frame.
	 */
	public resultpage(String roomType, int amount, String location, 
			String checkIn, String checkOut, String comments, int days, int amount1, int amount2, int amount3, int amount4, 
			String roomType1, String roomType2, String roomType3, String roomType4,String email, String firstname, String lastname, String phone1) {
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				String host="nexus.stevens.edu";   
				  final String user = "jwang102";  
				  final String password = new String("Stevens602953");
				   ...
				   if(!user.equals("") && !password.equals(""))
				   {
				     ...
				     {  
				        ...
				        message.setText( "First Name: " + Fname + "\n" + "Last Name: " + Lname +
				        		"\n" + "Room Type: " + roomType + "\n" + "Amount: " + amount + 
