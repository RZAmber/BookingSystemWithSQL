		...
		JTextArea txtrJieshao = new JTextArea(); 
 		...
 		btnConfirm.addActionListener(new ActionListener(){
 			public void actionPerformed(ActionEvent e){
 				...
 				CheckPage.setSize(1000,750);
 				CheckPage.setVisible(true);
 				CheckPage.setDefaultCloseOperation(EXIT_ON_CLOSE);
 				//CheckPage.textField_4.setText(HomePage.s + " ");
 				//CheckPage.textField_5.setText(HomePage.s1 + " ");
 			}
 		});
